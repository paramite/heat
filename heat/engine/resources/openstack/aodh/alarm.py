...
class AodhParseLiveResourceDataMixin:
...
class AodhAlarm(alarm_base.BaseAlarm, AodhBaseActionsMixin):
...
class EventAlarm(alarm_base.BaseAlarm, AodhBaseActionsMixin):
...
class LBMemberHealthAlarm(alarm_base.BaseAlarm, AodhBaseActionsMixin):
...
class PrometheusAlarm(alarm_base.BaseAlarm,
                      AodhBaseActionsMixin,
                      AodhParseLiveResourceDataMixin):
    ...
    support_status = support.SupportStatus(version='20.0.0')
    ...
    properties_schema = {
        ...
        QUERY: properties.Schema(
            properties.Schema.STRING,
            _('The PromQL query string to fetch metrics data from Prometheus.'),
            required=True,
            update_allowed=True
        ),
        THRESHOLD: properties.Schema(
